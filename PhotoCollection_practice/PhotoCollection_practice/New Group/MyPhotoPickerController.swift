...
protocol MyPhotoPickerControllerDelegate  : class {
    func postEditorPhotoPickerController(_ picker : MyPhotoPickerController, didFinishPickingContents contents: [PostContent]? )
}

class MyPhotoPickerController: UIViewController {

    weak var delegate : MyPhotoPickerControllerDelegate?
...
extension MyPhotoPickerController : UICollectionViewDelegate , UICollectionViewDelegateFlowLayout {
    
}

//extension MyPhotoPickerController : UICollectionViewDataSource {
