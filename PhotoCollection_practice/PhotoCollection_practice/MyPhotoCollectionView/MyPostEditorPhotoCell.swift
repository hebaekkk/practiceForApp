...
protocol MyPostEditorPhotoCellDelegate: class {
    func deletePhotoCell(_ sender: MyPostEditorPhotoCell)
    func editPhotoCell(_ sender: MyPostEditorPhotoCell)
}

class MyPostEditorPhotoCell: BaseCell {
    
    static let identifier = "MyPostEditorPhotoCell"
    var content: MyPostContent? {
        didSet{
    ...
    weak var delegate: MyPostEditorPhotoCellDelegate?
